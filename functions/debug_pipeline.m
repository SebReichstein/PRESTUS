...
cd 'C:\Users\reich\Matlab\PRESTUS-master\' % change path to demo data here
...
parameters = load_parameters('win_ernie_dataset_config.yaml'); % load the configuration file
